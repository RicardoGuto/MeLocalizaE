...
arquivo = "./risco_hidrologico/hidrologico_consolidado.csv"
# Caminho do arquivo de saída (vai sendo atualizado)
saida = "./risco_hidrologico/hidrologico_consolidado_expandido.csv"
...
# Configura transformação de UTM 23S (SIRGAS 2000) → WGS84
transformer = Transformer.from_crs("EPSG:31983", "EPSG:4326", always_xy=True)

# A PARTIR DA LINHA QUE VOCÊ QUER RECOMEÇAR
inicio = 0 # linha 675 do CSV
